...
public class FosilYakitKaynagi extends EnergySource implements Kaynaklar_Methods {
    protected static int kaynakSayisi;

    public FosilYakitKaynagi(int gunlukUretim, String tip, int kapasite, String kaynakNumarasi) {
