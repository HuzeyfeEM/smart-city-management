...
public class NukleerKaynagi extends EnergySource implements Kaynaklar_Methods {
    protected static int kaynakSayisi;

    public NukleerKaynagi(int gunlukUretim, String tip, int kapasite, String kaynakNumarasi) {
