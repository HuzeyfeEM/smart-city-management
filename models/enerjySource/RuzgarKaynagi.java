...
public class RuzgarKaynagi extends EnergySource implements Kaynaklar_Methods {
    protected static int kaynakSayisi;

    public RuzgarKaynagi(int gunlukUretim, String tip, int kapasite, String kaynakNumarasi) {
